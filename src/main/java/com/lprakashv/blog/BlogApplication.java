...
public class BlogApplication {
	...
	public void initdb() {
		...
		sb.append("<h3>Some Title</h3>");
		sb.append("<p>One of the great things about Thymeleaf Fragments is that we can also grab any part of a template just using the simple selectors, through classes, ids, or simply by tags.\n" +
				"\n" +
				"This page, for example, includes some components from general.html file: an aside block and the div.another block:</p>");

		sb.append("<h3>Some Other Title</h3>");
		sb.append("<p>We can pass parameters to a fragment in order to change some specific part of it. To do that, the fragment must be defined as a function call, where we must declare a list of parameters.\n" +
				"\n" +
